...
public class AdTemplate {
	...
	private static final String TEXT_AD_TEMPLATE = "<a native target=\"_blank\" style=\"text-decoration: none;\">"
			+ "<div style=\"background-color: %s; color: %s;" + TEXT_AD_STYLE + "\"> %s </div></a>";
	private static final String IMAGE_AD_TEMPLATE = "<a native target=\"_blank\">"
	...
	public static String assembleUsingTextAd(TextAd ad) {
		return String.format(TEXT_AD_TEMPLATE, ad.getBgColor(), ad.getTextColor(), ad.getText());
	}

	public static String assembleUsingImageAd(ImageAd ad) {
		return String.format(IMAGE_AD_TEMPLATE, ad.getImageUrl());
